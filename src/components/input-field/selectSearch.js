        ...
        return (
            <div className="select-header">
                ...
                <ul ref={ref => this.scrollSelect = ref}
                    className={this.state.selected ? "list-hospital popup-list mostly-customized-scrollbar display-lists" : 'list-hospital popup-list mostly-customized-scrollbar'}
