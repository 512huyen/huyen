...
class Wallets extends React.Component {
    ...
    render() {
        ...
        const { listHospital, date, time, time2, date2, listPaymentAgent, hospitalId, paymentAgentId, paymentMethod, listPaymentMethod, checkValidate, userHospitalId, userHospitalName } = this.state;
        return (
