...
class Wallets extends React.Component {
    ...
    render() {
        ...
        const { listHospital, userHospitalName, userHospitalId, date, time, time2, date2, listPaymentAgent, hospitalId, paymentAgentId, paymentMethod, listPaymentMethod, checkValidate } = this.state;
        return (
