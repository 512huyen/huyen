                                ...
                                <Table aria-labelledby="tableTitle" className="style-table-new style-table-new-his-hospital">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell style={{ width: "15%" }}>Họ và tên</TableCell>
                                            <TableCell style={{ width: "20%" }}>Hạn mức nạp tiền</TableCell>
                                            <TableCell style={{ width: "15%" }}>Khoa/ Phòng</TableCell>
                                            <TableCell style={{ width: "10%" }}>Nhà</TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {
