...
class DetailHospital extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            accounts: this.props.data && this.props.data.hospital && this.props.data.hospital.accounts ? this.props.data.hospital.accounts : '',
    ...
    render() {
        ...
        const { dataHospital, status, issueDateTaxNo, taxNo, name, address, fax, phone, code, accounts, listPaymentMethod, listKeyMethod, dataHisHospital } = this.state;
                                        ...
                                        <div className="group-detail-colx2 color-border">
                                            ...
                                            <div className="detail-item">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-8">
                                                        <p className="name-file file-padding" onClick={()=> this.modalDetail(dataHospital)}>{accounts}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
