...
class Card extends Component {
    ...
    componentWillMount() {
        let id = this.props.userApp.currentUser && this.props.userApp.currentUser.hospital && this.props.userApp.currentUser.hospital.id
        this.getBank();
        this.getHospital();
        this.loadPage(id);
        this.getAgent(id);
        this.getPaymentMethodsHospital(id);
    ...
    render() {
        const { classes } = this.props;
        const { data, page, progress, selected, stt, total, size, dataCard, name, listHospitalCreate, listBank, hospitalId, listAgent, listPaymentMethodsHospital, listPaymentAgent } = this.state;
        return (
            <div>
                        ...
                        <Grid item xs={12} lg={8} md={7}>
                            <div className={classes.tableWrapper + ' page-wrapper page-wrapper-card'}>
                                <div className="page-title">
                                    <h2 className="title-page">Lịch sử bàn giao thẻ</h2>
