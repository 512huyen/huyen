...
class DetailPaymentAgent extends React.Component {
    ...
    render() {
        ...
        const { transferUser, cardNoFrom, cardNoTo, receiverUser, hospitalId, quantity, transferDate, paymentAgentNameAbb, bankId } = this.state;
        return (
                            ...
                            <div className="group-detail">
                                ...
                                <div className="detail-item">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            <p className="content-detail">Từ {cardNoFrom} đến {cardNoTo}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="detail-item">
