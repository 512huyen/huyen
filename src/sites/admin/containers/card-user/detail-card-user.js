...
class DetailCardUser extends React.Component {
    ...
    render() {
        ...
        const { dataCardUser, deleted, nameAbb, nameExchange, name, address, fax, phone, bookingTime, code, taxCode, issueDate } = this.state;
                                        ...
                                        <div className="group-detail-colx3">
                                            ...
                                            <div className="detail-item" style={{ marginTop: 15 }}>
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-7">
                                                        {
                                                            dataCardUser.card.deleted === 0 ?
                                                                <p className="content-detail">Đang hoạt động</p> :
                                                                dataCardUser.card.deleted === 1 ? <p className="content-detail">Đã khóa</p> : null
                                                        }
