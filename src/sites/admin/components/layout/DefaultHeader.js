          ...
          <AppBar position="static">
            <Toolbar>
              ...
              <div className={classes.sectionDesktop + " default-header-title"}>
                <span className="name-csyt-top item-right">{this.props.userApp.currentUser && this.props.userApp.currentUser.name ? this.props.userApp.currentUser.name : this.props.userApp.currentUser && this.props.userApp.currentUser.hospital ? this.props.userApp.currentUser.hospital.name : null}</span>
