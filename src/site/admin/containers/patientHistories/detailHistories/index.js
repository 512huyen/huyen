...
function index(props) {
    ...
    return (
        <>
            ...
            >
                <div>
                    <div>{props.dataPatientDocument[0] && props.dataPatientDocument[0].patientName}</div>
                    <div>{props.dataPatientDocument[0] && props.dataPatientDocument[0].birthdayStr}</div>
                    <div>Mã NB{props.dataPatientDocument[0] && props.dataPatientDocument[0].patientValue}</div>
                    <div>Mã HS{props.dataPatientDocument[0] && props.dataPatientDocument[0].patientDocument}</div>
                </div>
                <Panel
